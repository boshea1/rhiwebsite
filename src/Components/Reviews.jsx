...
const Reviews = () => {
  ...
  <div className="stat sm:invisible md:invisible lg:visible lg:border-r-2 lg:border-black">
  ...
  <div className="stat sm:border-none md:border-2 md:border-black">
  ...
  <div className="stat sm:invisible md:invisible lg:visible">
    <div className="stat-figure text-secondary">
